...
This lab checks for the core Section 1 toolkit on your machine; it does not
...
| Tool | Section 1 day | Install if missing |
| ---- | ------------- | ------------------ |
...
must run on any machine that finished Section 1, including one with gaps.
